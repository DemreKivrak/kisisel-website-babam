        ...
        <div className="ml-30 flex items-center text-white text-[17px] gap-15">
          ...
          <div className="relative group">
            ...
            <ul className="invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 absolute top-full left-0 bg-white text-gray-800 shadow-lg rounded-md mt-2 min-w-[200px] py-2 z-50 border-1">
              <li className="hover:bg-gray-100 px-4 py-2 cursor-pointer transition hover:text-amber-300">
                <a className="block w-full">Tour-type-a</a>
              </li>
              <li className="hover:bg-gray-100 px-4 py-2 cursor-pointer transition hover:text-amber-300">
                <a className="block w-full">Tour-type-b</a>
              </li>
              <li className="hover:bg-gray-100 px-4 py-2 cursor-pointer transition hover:text-amber-300">
                <a className="block w-full">Tour-type-c</a>
              </li>
            </ul>
          </div>
          ...
          <div className="relative group">
            ...
            <ul className="invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 absolute top-full left-0 bg-white text-gray-800 shadow-lg rounded-md mt-2 min-w-[200px] py-2 z-50 border-1">
              <li className="hover:bg-gray-100 px-4 py-2 cursor-pointer transition hover:text-amber-300">
                <a className="block w-full">Destination 1</a>
              </li>
              <li className="hover:bg-gray-100 px-4 py-2 cursor-pointer transition hover:text-amber-300">
                <a className="block w-full">Destination 2</a>
              </li>
              <li className="hover:bg-gray-100 px-4 py-2 cursor-pointer transition hover:text-amber-300">
                <a className="block w-full">Destination 3</a>
              </li>
            </ul>
          </div>
