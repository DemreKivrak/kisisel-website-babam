...
const resources = {
  en: {
    translation: {
      ...
      "about.introText": "Since 2000, we have been your travel companion at the heart of the tourism sector with our expertise in transportation and agency services. As Oltre Tours, we combine the experience of years with a modern service approach, believing that transportation is not just about getting from one point to another, but a process of comfort.",
      "about.whyChooseTitle": "Why Work With Us?",
      "about.whyChooseSubtitle": "We are with you at every point you need, with our wide range of services",
      "about.fleetTitle": "Rich Vehicle Fleet",
      "about.fleetDesc": "We are at your service with our economical, comfortable and luxury segment vehicle fleet that meets all kinds of needs, from small groups to large organizations.",
      "about.corporateTitle": "Corporate Solutions",
      "about.corporateDesc": "We manage the staff shuttle, VIP transfer and event transportation needs of corporations with the principles of punctuality and professionalism.",
      "about.touristTitle": "Domestic and Foreign Tourist Services",
      "about.touristDesc": "We offer our guests who discover the beauties of Turkey not just a transfer service, but a safe and peaceful travel experience.",
      "about.expertTitle": "Expert Staff",
      "about.expertDesc": "Experience the privilege of working with a team that knows the sector, masters operational processes and puts guest satisfaction above everything else.",
      "about.visionTitle": "Our Vision",
      "about.visionText": "On this journey we started in 2000, to continue to be the first 'point of trust' that comes to mind in transportation and agency by improving our vehicle park and service quality every day.",
      ...
      "about.ctaDesc": "With our 25 years of experience and wide service network, we are here to offer you the best travel experience.",
  ...
  tr: {
    translation: {
      ...
      "about.introText": "2000 yılından bu yana turizm sektörünün kalbinde; taşımacılık ve acentacılık alanındaki uzmanlığımızla yol arkadaşınız oluyoruz. Oltre Tours olarak, yılların getirdiği tecrübeyi modern hizmet anlayışıyla birleştirerek, ulaşımın sadece bir noktadan diğerine gitmek değil, bir konfor süreci olduğuna inanıyoruz.",
      "about.whyChooseTitle": "Neden Bizimle Çalışmalısınız?",
      "about.whyChooseSubtitle": "İhtiyacınız olan her noktada, geniş hizmet yelpazemizle yanınızdayız",
      "about.fleetTitle": "Zengin Araç Filosu",
      "about.fleetDesc": "Küçük gruplardan büyük organizasyonlara kadar her türlü ihtiyaca cevap veren; ekonomik, konforlu ve lüks segment araç filomuzla hizmetinizdeyiz.",
      "about.corporateTitle": "Kurumsal Çözümler",
      "about.corporateDesc": "Kurumların personel servisi, VIP transfer ve etkinlik taşımacılığı ihtiyaçlarını dakiklik ve profesyonellik ilkeleriyle yönetiyoruz.",
      "about.touristTitle": "Yerli ve Yabancı Turist Hizmetleri",
      "about.touristDesc": "Türkiye'nin güzelliklerini keşfeden misafirlerimize, sadece bir transfer hizmeti değil, güvenli ve huzurlu bir seyahat deneyimi sunuyoruz.",
      "about.expertTitle": "Uzman Kadro",
      "about.expertDesc": "Sektörü tanıyan, operasyonel süreçlere hakim ve misafir memnuniyetini her şeyin üzerinde tutan bir ekiple çalışmanın ayrıcalığını yaşayın.",
      "about.visionTitle": "Vizyonumuz",
      "about.visionText": "2000 yılında başladığımız bu yolculukta, her geçen gün araç parkurumuzu ve hizmet kalitemizi geliştirerek, taşımacılık ve acentacılıkta akla gelen ilk 'güven noktası' olmaya devam etmektir.",
      ...
      "about.ctaDesc": "25 yıllık tecrübemiz ve geniş hizmet ağımızla, sizlere en iyi seyahat deneyimini sunmak için buradayız.",
  ...
  de: {
    translation: {
      ...
      "about.introText": "Seit 2000 sind wir Ihr Reisebegleiter im Herzen der Tourismusbranche mit unserer Expertise im Transport- und Agenturwesen. Als Oltre Tours kombinieren wir die Erfahrung der Jahre mit einem modernen Serviceansatz und glauben, dass Transport nicht nur darum geht, von einem Punkt zum anderen zu gelangen, sondern ein Prozess des Komforts ist.",
      "about.whyChooseTitle": "Warum mit uns arbeiten?",
      "about.whyChooseSubtitle": "Wir sind an jedem Punkt, den Sie benötigen, mit unserem breiten Leistungsspektrum für Sie da",
      "about.fleetTitle": "Reichhaltige Fahrzeugflotte",
      "about.fleetDesc": "Wir stehen Ihnen mit unserer wirtschaftlichen, komfortablen und luxuriösen Fahrzeugflotte zur Verfügung, die alle Arten von Bedürfnissen erfüllt, von kleinen Gruppen bis zu großen Organisationen.",
      "about.corporateTitle": "Unternehmenslösungen",
      "about.corporateDesc": "Wir verwalten den Personalshuttle, VIP-Transfer und Veranstaltungstransport von Unternehmen nach den Prinzipien von Pünktlichkeit und Professionalität.",
      "about.touristTitle": "Dienstleistungen für inländische und ausländische Touristen",
      "about.touristDesc": "Wir bieten unseren Gästen, die die Schönheiten der Türkei entdecken, nicht nur einen Transferservice, sondern ein sicheres und friedliches Reiseerlebnis.",
      "about.expertTitle": "Expertenteam",
      "about.expertDesc": "Erleben Sie das Privileg, mit einem Team zu arbeiten, das die Branche kennt, operative Prozesse beherrscht und die Gästezufriedenheit über alles stellt.",
      "about.visionTitle": "Unsere Vision",
      "about.visionText": "Auf dieser Reise, die wir im Jahr 2000 begonnen haben, wollen wir weiterhin der erste 'Vertrauenspunkt' sein, der einem im Transport- und Agenturwesen einfällt, indem wir täglich unseren Fahrzeugpark und unsere Servicequalität verbessern.",
      "about.motto": "Straßen ändern sich, die Suche nach Komfort und Vertrauen nicht.",
      "about.tagline": "Jede Reise ist etwas Besonderes mit Oltre Tours",
      "about.ctaTitle": "Bereit, mit uns zu reisen?",
      "about.ctaDesc": "Mit unserer 25-jährigen Erfahrung und unserem umfangreichen Servicenetzwerk sind wir hier, um Ihnen das beste Reiseerlebnis zu bieten.",
  ...
  fr: {
    translation: {
      ...
      "about.introText": "Depuis 2000, nous sommes votre compagnon de voyage au cœur du secteur touristique avec notre expertise dans les services de transport et d'agence. Chez Oltre Tours, nous combinons l'expérience des années avec une approche de service moderne, croyant que le transport n'est pas seulement un déplacement d'un point à un autre, mais un processus de confort.",
      "about.whyChooseTitle": "Pourquoi travailler avec nous?",
      "about.whyChooseSubtitle": "Nous sommes à vos côtés à chaque point où vous en avez besoin, avec notre large gamme de services",
      "about.fleetTitle": "Flotte de véhicules riche",
      "about.fleetDesc": "Nous sommes à votre service avec notre flotte de véhicules économiques, confortables et de luxe qui répond à tous les types de besoins, des petits groupes aux grandes organisations.",
      "about.corporateTitle": "Solutions d'entreprise",
      "about.corporateDesc": "Nous gérons les besoins de navette du personnel, de transfert VIP et de transport d'événements des entreprises selon les principes de ponctualité et de professionnalisme.",
      "about.touristTitle": "Services pour touristes nationaux et étrangers",
      "about.touristDesc": "Nous offrons à nos invités qui découvrent les beautés de la Turquie non seulement un service de transfert, mais une expérience de voyage sûre et paisible.",
      "about.expertTitle": "Équipe d'experts",
      "about.expertDesc": "Vivez le privilège de travailler avec une équipe qui connaît le secteur, maîtrise les processus opérationnels et place la satisfaction des clients au-dessus de tout.",
      "about.visionTitle": "Notre vision",
      "about.visionText": "Dans ce voyage que nous avons commencé en 2000, continuer à être le premier 'point de confiance' qui vient à l'esprit dans le transport et l'agence en améliorant notre parc automobile et notre qualité de service chaque jour.",
      "about.motto": "Les routes changent, la recherche de confort et de confiance ne change pas.",
      "about.tagline": "Chaque voyage est spécial avec Oltre Tours",
      "about.ctaTitle": "Prêt à voyager avec nous?",
      "about.ctaDesc": "Avec nos 25 ans d'expérience et notre large réseau de services, nous sommes là pour vous offrir la meilleure expérience de voyage.",
  ...
  es: {
    translation: {
      ...
      "about.introText": "Desde 2000, hemos sido su compañero de viaje en el corazón del sector turístico con nuestra experiencia en servicios de transporte y agencia. Como Oltre Tours, combinamos la experiencia de los años con un enfoque de servicio moderno, creyendo que el transporte no es solo ir de un punto a otro, sino un proceso de comodidad.",
      "about.whyChooseTitle": "¿Por qué trabajar con nosotros?",
      "about.whyChooseSubtitle": "Estamos con usted en cada punto que necesite, con nuestra amplia gama de servicios",
      "about.fleetTitle": "Flota de vehículos rica",
      "about.fleetDesc": "Estamos a su servicio con nuestra flota de vehículos económicos, cómodos y de lujo que satisface todo tipo de necesidades, desde pequeños grupos hasta grandes organizaciones.",
      "about.corporateTitle": "Soluciones corporativas",
      "about.corporateDesc": "Gestionamos las necesidades de transporte de personal, traslados VIP y eventos de las empresas con los principios de puntualidad y profesionalismo.",
      "about.touristTitle": "Servicios para turistas nacionales y extranjeros",
      "about.touristDesc": "Ofrecemos a nuestros huéspedes que descubren las bellezas de Turquía no solo un servicio de traslado, sino una experiencia de viaje segura y tranquila.",
      "about.expertTitle": "Equipo experto",
      "about.expertDesc": "Experimente el privilegio de trabajar con un equipo que conoce el sector, domina los procesos operativos y pone la satisfacción del cliente por encima de todo.",
      "about.visionTitle": "Nuestra visión",
      "about.visionText": "En este viaje que comenzamos en 2000, continuar siendo el primer 'punto de confianza' que viene a la mente en transporte y agencia mejorando nuestro parque de vehículos y calidad de servicio cada día.",
      "about.motto": "Los caminos cambian, la búsqueda de comodidad y confianza no cambia.",
      "about.tagline": "Cada viaje es especial con Oltre Tours",
      "about.ctaTitle": "¿Listo para viajar con nosotros?",
      "about.ctaDesc": "Con nuestros 25 años de experiencia y amplia red de servicios, estamos aquí para ofrecerle la mejor experiencia de viaje.",
  ...
  ru: {
    translation: {
      ...
      "about.introText": "С 2000 года мы являемся вашим попутчиком в самом сердце туристического сектора с нашим опытом в транспортных и агентских услугах. Как Oltre Tours, мы сочетаем опыт многих лет с современным подходом к обслуживанию, считая, что транспорт — это не просто перемещение из одной точки в другую, а процесс комфорта.",
      "about.whyChooseTitle": "Почему работать с нами?",
      "about.whyChooseSubtitle": "Мы с вами в каждой точке, где вам нужна помощь, с нашим широким спектром услуг",
      "about.fleetTitle": "Богатый автопарк",
      "about.fleetDesc": "Мы к вашим услугам с нашим экономичным, комфортабельным и роскошным автопарком, который отвечает всем видам потребностей, от небольших групп до крупных организаций.",
      "about.corporateTitle": "Корпоративные решения",
      "about.corporateDesc": "Мы управляем потребностями корпораций в персональном трансфере, VIP-трансфере и транспортировке мероприятий по принципам пунктуальности и профессионализма.",
      "about.touristTitle": "Услуги для местных и иностранных туристов",
      "about.touristDesc": "Мы предлагаем нашим гостям, которые открывают для себя красоты Турции, не просто услугу трансфера, а безопасный и спокойный опыт путешествия.",
      "about.expertTitle": "Экспертная команда",
      "about.expertDesc": "Ощутите привилегию работы с командой, которая знает отрасль, владеет операционными процессами и ставит удовлетворенность гостей превыше всего.",
      "about.visionTitle": "Наше видение",
      "about.visionText": "В этом путешествии, которое мы начали в 2000 году, продолжать быть первой 'точкой доверия', которая приходит на ум в транспорте и агентстве, улучшая наш автопарк и качество обслуживания каждый день.",
      ...
      "about.ctaDesc": "С нашим 25-летним опытом и широкой сетью услуг мы здесь, чтобы предложить вам лучший опыт путешествий.",
  ...
  ja: {
    translation: {
      ...
      "about.introText": "2000年から、輸送と代理店サービスにおける専門知識を持って、観光セクターの中心であなたの旅の仲間となっています。Oltre Toursとして、長年の経験と現代的なサービスアプローチを組み合わせ、輸送は単にある地点から別の地点に移動することではなく、快適さのプロセスであると信じています。",
      "about.whyChooseTitle": "なぜ私たちと働くのか？",
      "about.whyChooseSubtitle": "私たちは幅広いサービスで、あなたが必要とするすべての場所であなたと共にいます",
      "about.fleetTitle": "豊富な車両フリート",
      "about.fleetDesc": "小規模なグループから大規模な組織まで、あらゆる種類のニーズに対応する経済的、快適、高級セグメントの車両フリートでサービスを提供しています。",
      "about.corporateTitle": "企業向けソリューション",
      "about.corporateDesc": "企業のスタッフシャトル、VIPトランスファー、イベント輸送のニーズを時間厳守とプロフェッショナリズムの原則で管理しています。",
      "about.touristTitle": "国内外の観光客向けサービス",
      "about.touristDesc": "トルコの美しさを発見するゲストに、単なる送迎サービスではなく、安全で平和な旅行体験を提供しています。",
      "about.expertTitle": "専門チーム",
      "about.expertDesc": "業界を知り、運用プロセスをマスターし、ゲストの満足を何よりも優先するチームと働く特権を体験してください。",
      "about.visionTitle": "私たちのビジョン",
      "about.visionText": "2000年に始めたこの旅において、毎日車両パークとサービス品質を改善することで、輸送と代理店で思い浮かぶ最初の「信頼のポイント」であり続けることです。",
      "about.motto": "道は変わりますが、快適さと信頼の追求は変わりません。",
      "about.tagline": "Oltre Toursとのすべての旅は特別です",
      "about.ctaTitle": "私たちと一緒に旅行する準備はできていますか？",
      "about.ctaDesc": "25年の経験と広範なサービスネットワークで、最高の旅行体験を提供するためにここにいます。",
